...
const TacticsBoard = () => {
  ...
  return (
    <div className="layout-wrapper">
      <h1 className="app-title">StratGen Tactics</h1>
      ...
      <div className="tactics-container">
        ...
        <div
          ...
          style={{
            ...
            position: 'relative',
            // backgroundColor: '#1e2025', // Removed to allow glassmorphism from CSS
            userSelect: 'none'
          }}
        ...
        <div className="sidebar">
          ...
          <div className="stats-panel">
            <div className="stat-item">
              ...
              <div className="stat-value" style={{ color: attack > 11 ? 'var(--accent-alert)' : 'var(--accent-cyan)' }}>
                {attack}
              </div>
            </div>
            <div className="stat-item">
              <div className="stat-label">Defenders</div>
              <div className="stat-value" style={{ color: defense > 11 ? 'var(--accent-alert)' : 'var(--accent-magenta)' }}>
                {defense}
              </div>
            </div>
          </div>
